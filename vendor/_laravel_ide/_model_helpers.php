...
namespace App\Models {
     ...
     * @property string|null $image_layanan
     * @property string|null $harga_layanan
     * @property string|null $detail_layanan
     * @property string|null $nama_layanan
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Layanan>|Layanan whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Layanan>|Layanan whereNamaLayanan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Layanan>|Layanan whereDetailLayanan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Layanan>|Layanan whereHargaLayanan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Layanan>|Layanan whereImageLayanan($value)
